...
public class Sudoku {
	...
	private int[][] game2; // Generated game with user input.
	private int[][] game3; // Generated game with user input.
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<9;i++){
			for(int j=0;j<9;j++){
				System.out.print(sudoku.solution[i][j]+" ");
			}
			System.out.println();
		}
		System.out.println();
		...
		for(int i=0;i<9;i++){
			for(int j=0;j<9;j++){
				System.out.print(sudoku.game[i][j]+" ");
			}
			System.out.println();
		}
	}
	 ...
	 * @return True if game is valid, false otherwise.
	 */
	private boolean isValid(int[][] game, int index, int[] numberOfSolutions) {//ArrayList set;
		if (index > 80)
