...
/*
 * Given an array of integer, create all combination in decreasing order and return the combination at given index.
 * No need to create all combination, target is just the value at given index.
 * 
 * 
 */
/**
